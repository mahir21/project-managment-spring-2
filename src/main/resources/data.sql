...
insert into employee (employee_id, getFirstName, lastName, email) values (1, 'John', 'Warton', 'warton@gmail.com');
insert into employee (employee_id, first_name, last_name, email) values (2, 'Mike', 'Lanister', 'lansiter');
